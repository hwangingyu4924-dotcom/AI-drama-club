-- AI-drama-club private rehearsal image Storage setup
-- Fresh install: run after schema.sql and rls.sql.
-- Existing database: use rehearsal_images_storage_migration.sql instead.
